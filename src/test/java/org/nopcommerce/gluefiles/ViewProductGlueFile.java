...
@ConfigurationParameter(key = Constants.FEATURES_PROPERTY_NAME,value = "src/test/resources/featureFiles/ViewProductBDD.feature")
...
public class ViewProductGlueFile {
}
